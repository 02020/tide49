...
export const ConfigureKeyboard = (props: {
  ...
  const {selectable, dimensions, matrixKeycodes: propKeycodes, layerLabel} = props;
  const storeMatrixKeycodes = useAppSelector(
    (state) => getSelectedKeymap(state) || [],
  );
  const matrixKeycodes = propKeycodes || storeMatrixKeycodes;
